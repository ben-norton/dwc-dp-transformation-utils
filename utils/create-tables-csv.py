...
def generate_tables_csv():
	...
	df.rename(columns={'name':'table_name', 'identifier':'uri', 'url':'source', 'title':'skos:prefLabel', 'description':'skos:definition'}, inplace=True)
	df.columns = ['rr:tableName','uri','dcterms:source','skos:prefLabel','skos:definition']
