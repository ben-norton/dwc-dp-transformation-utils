...
def generate_columns_csv():
	...
	df_results.rename(columns={'column_name': 'csvw:column',
	                           'title': 'skos:prefLabel',
	                           'column_description': 'skos:description',
	                           'column_type': 'csvw:datatype',
	                           'column_format': 'csvw:format',
	                           'column_comments': 'skos:note',
	                           'column_examples': 'skos:example',
	                           'column_namespace': 'vann:preferredNamespacePrefix',
	                           'column_iri': 'iri',
	                           'column_constraints.required': 'csvw:required',
	                           'column_constraints.unique': 'dsd:isUnique',
	                           'column_constraints.minimum': 'csvw:minLength',
	                           'name': 'csvw:table',
	                           'title': 'dcterms:title'}, inplace=True)
